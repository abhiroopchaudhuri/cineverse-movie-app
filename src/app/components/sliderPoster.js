      ...
      <FaAngleDoubleLeft className="md:size-6"></FaAngleDoubleLeft></button>
        ...
        >
          {movieData.map((movie, index) => (
            <div
              className={`relative flex flex-col items-center justify-end text-center rounded-lg overflow-hidden min-w-[calc(25%-6px)] md:min-w-[calc((100%-80px)/6)] h-auto aspect-[3/4] z-[1] ${
